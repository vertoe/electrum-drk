...
from electrum_drk.util import get_resource_path as rsrc
...
import re
import time
from electrum_drk.wallet import Wallet, WalletStorage
import webbrowser
import history_widget
import receiving_widget
from electrum_drk import util
import datetime

from electrum_drk.version import ELECTRUM_VERSION as electrum_version
from electrum_drk.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        resize_line_edit_width(self.address_input,
                               "X1taFUr3qVvAmwrsuDuu5zk6e4s2rxd2Gy")
